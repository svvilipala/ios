...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let product4 = product(prodName: "AitPods Pro", prodDescription: "This is a new Airpords")
        productArray.append(product4)
        let product5 = product(prodName: "AitPods Pro", prodDescription: "This is a new Airpords")
